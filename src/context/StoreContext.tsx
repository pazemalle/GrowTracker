...
export const StoreProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    // NEW: Clear all data (used during logout to prevent data leakage)
    const clearData = () => {
