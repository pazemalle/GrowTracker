                ...
                <div className="p-4 border-t border-slate-700 space-y-4 bg-slate-900/30">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                            <div>
                                ...
                                <input className="input text-xs w-full bg-slate-900/50 border-slate-700" placeholder={t.profiles.tempPlaceholder} value={config.temp} onChange={e => onChange({ ...config, temp: e.target.value })} style={{ backgroundColor: 'rgba(15, 23, 42, 0.5)', color: 'white', borderColor: '#334155' }} />
                            </div>
                            <div>
                                <label className="text-[10px] text-slate-500 block mb-1">{t.growDetail.humidity}</label>
                                <input className="input text-xs w-full bg-slate-900/50 border-slate-700" placeholder={t.profiles.humidityPlaceholder} value={config.humidity} onChange={e => onChange({ ...config, humidity: e.target.value })} style={{ backgroundColor: 'rgba(15, 23, 42, 0.5)', color: 'white', borderColor: '#334155' }} />
                            </div>
                            <div>
                                <label className="text-[10px] text-slate-500 block mb-1">{t.growDetail.vpd}</label>
                                <input className="input text-xs w-full bg-slate-900/50 border-slate-700" placeholder="kPa" value={config.vpd || ''} onChange={e => onChange({ ...config, vpd: e.target.value })} style={{ backgroundColor: 'rgba(15, 23, 42, 0.5)', color: 'white', borderColor: '#334155' }} />
                            </div>
                            <div>
                                <label className="text-[10px] text-slate-500 block mb-1 text-yellow-400 font-bold">EC</label>
                                <input className="input text-xs w-full bg-slate-900/50 border-yellow-500/30 text-yellow-500" placeholder="dS/m" value={config.ec || ''} onChange={e => onChange({ ...config, ec: e.target.value })} style={{ backgroundColor: 'rgba(15, 23, 42, 0.5)', color: '#eab308', borderColor: 'rgba(234, 179, 8, 0.3)' }} />
                            </div>
                            <div>
                                <label className="text-[10px] text-slate-500 block mb-1 text-teal-400 font-bold">pH</label>
                                <input className="input text-xs w-full bg-slate-900/50 border-teal-500/30 text-teal-500" placeholder="pH" value={config.ph || ''} onChange={e => onChange({ ...config, ph: e.target.value })} style={{ backgroundColor: 'rgba(15, 23, 42, 0.5)', color: '#14b8a6', borderColor: 'rgba(20, 184, 166, 0.3)' }} />
                            </div>
                            <div>
                                <label className="text-[10px] text-slate-500 block mb-1">{t.growDetail.dli}</label>
                                <input className="input text-xs w-full bg-slate-900/50 border-slate-700" placeholder="mol/m²/d" value={config.dli || ''} onChange={e => onChange({ ...config, dli: e.target.value })} style={{ backgroundColor: 'rgba(15, 23, 42, 0.5)', color: 'white', borderColor: '#334155' }} />
                            </div>
                            <div>
                                <label className="text-[10px] text-slate-500 block mb-1">{t.growDetail.ppfd}</label>
                                <input className="input text-xs w-full bg-slate-900/50 border-slate-700" placeholder="µmol/m²/s" value={config.ppfd || ''} onChange={e => onChange({ ...config, ppfd: e.target.value })} style={{ backgroundColor: 'rgba(15, 23, 42, 0.5)', color: 'white', borderColor: '#334155' }} />
                            </div>
                            <div className="col-span-2">
                                <label className="text-[10px] text-slate-500 block mb-1">{t.growDetail.lightCycle}</label>
                                <input className="input text-xs w-full bg-slate-900/50 border-slate-700" placeholder="e.g. 18/6" value={config.lightCycle || ''} onChange={e => onChange({ ...config, lightCycle: e.target.value })} list="light-cycles" style={{ backgroundColor: 'rgba(15, 23, 42, 0.5)', color: 'white', borderColor: '#334155' }} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex gap-2 mb-2">
                            <select className="input text-xs flex-1 bg-slate-900/50 border-slate-700 text-slate-300" value={newNutrientId} onChange={e => setNewNutrientId(e.target.value)} style={{ backgroundColor: 'rgba(15, 23, 42, 0.5)', color: '#cbd5e1', borderColor: '#334155' }}>
                                <option value="">Select Nutrient</option>
                                {availableNutrients.map(n => <option key={n.id} value={n.id}>{n.name}</option>)}
                            </select>
                            <input className="input text-xs w-16 bg-slate-900/50 border-slate-700" placeholder="ml/L" value={newNutrientAmount} onChange={e => setNewNutrientAmount(e.target.value)} type="number" style={{ backgroundColor: 'rgba(15, 23, 42, 0.5)', color: 'white', borderColor: '#334155' }} />
                    ...
                    <div>
                        ...
                        <div className="flex gap-2 mb-2">
                            <input className="input text-xs w-16 bg-slate-900/50 border-slate-700" placeholder="Day" value={newTaskDay} onChange={e => setNewTaskDay(e.target.value)} type="number" style={{ backgroundColor: 'rgba(15, 23, 42, 0.5)', color: 'white', borderColor: '#334155' }} />
                            <input className="input text-xs flex-1 bg-slate-900/50 border-slate-700" placeholder="Task description" value={newTaskDesc} onChange={e => setNewTaskDesc(e.target.value)} style={{ backgroundColor: 'rgba(15, 23, 42, 0.5)', color: 'white', borderColor: '#334155' }} />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <div>
                        ...
                        <input
                            ...
                            style={{ backgroundColor: 'rgba(30, 41, 59, 0.5)', color: 'white', borderColor: '#334155' }}
